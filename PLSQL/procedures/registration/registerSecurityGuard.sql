CREATE OR REPLACE PROCEDURE registerSecurityGuard (
    p_name IN VARCHAR2,
    p_pass IN VARCHAR2,
    p_addr IN VARCHAR2,
    p_phone IN VARCHAR2,
...
BEGIN
    ...
    INSERT INTO SecurityGuard_Details (sp_id, sg_weapons_training)
    VALUES (new_id, p_weapons_training);
END;
/
